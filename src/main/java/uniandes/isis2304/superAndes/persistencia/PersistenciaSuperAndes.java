 ...
 * Se apoya en las clases SQLBar, SQLBebedor, SQLBebida, SQLGustan, SQLSirven, SQLTipoProducto y SQLVisitan, que son 
...
public class PersistenciaSuperAndes 
{
	...
	public TipoProducto adicionarTipoProducto(String nombre)
	{
        ...
        {
            tx.begin();
            long idTipoProducto = nextval ();
            long tuplasInsertadas = sqlTipoProducto.adicionarTipoProducto(pm, idTipoProducto, nombre);
            tx.commit();
            
            log.trace ("Inserción de tipo de bebida: " + nombre + ": " + tuplasInsertadas + " tuplas insertadas");
            
            return new TipoProducto (idTipoProducto, nombre);
        }
        catch (Exception e)
        {
//        	e.printStackTrace();
	...
	/**
	 * Método que elimina, de manera transaccional, una tupla en la tabla TipoProducto, dado el nombre del tipo de bebida
	 * Adiciona entradas al log de la aplicación
	 * @param nombre - El nombre del tipo de bebida
	...
	public long eliminarTipoProductoPorNombre (String nombre) 
	{
        ...
        {
            tx.begin();
            long resp = sqlTipoProducto.eliminarTipoProductoPorNombre(pm, nombre);
            tx.commit();
            return resp;
        }
        catch (Exception e)
...
//        	e.printStackTrace();
	...
	/**
	 * Método que elimina, de manera transaccional, una tupla en la tabla TipoProducto, dado el identificador del tipo de bebida
	 * Adiciona entradas al log de la aplicación
	...
	public long eliminarTipoProductoPorId (long idTipoProducto) 
	{
        ...
        {
            tx.begin();
            long resp = sqlTipoProducto.eliminarTipoProductoPorId(pm, idTipoProducto);
            tx.commit();
            return resp;
        }
        catch (Exception e)
...
//        	e.printStackTrace();
	 ...
	 * @return La lista de objetos TipoProducto, construidos con base en las tuplas de la tabla TIPOBEBIDA
	 */
	...
	/**
	 * Método que consulta todas las tuplas en la tabla TipoProducto que tienen el nombre dado
	 * @param nombre - El nombre del tipo de bebida
	 * @return La lista de objetos TipoProducto, construidos con base en las tuplas de la tabla TIPOBEBIDA
	 */
	public List<TipoProducto> darTipoProductoPorNombre (String nombre)
	{
		return sqlTipoProducto.darTiposProductoPorNombre (pmf.getPersistenceManager(), nombre);
	}
 
	/**
	 * Método que consulta todas las tuplas en la tabla TipoProducto con un identificador dado
	 * @param idTipoProducto - El identificador del tipo de bebida
	 * @return El objeto TipoProducto, construido con base en las tuplas de la tabla TIPOBEBIDA con el identificador dado
	 */
	public TipoProducto darTipoProductoPorId (long idTipoProducto)
	{
		return sqlTipoProducto.darTipoProductoPorId (pmf.getPersistenceManager(), idTipoProducto);
	}
	 ...
	 * @param idTipoProducto - El identificador del tipo de bebida (Debe existir en la tabla TipoProducto)
	...
	public Cliente adicionarBebida(String nombre, long idTipoProducto, int gradoAlcohol) 
	{
        ...
        try
        {
            ...
            long tuplasInsertadas = sqlBebida.adicionarBebida(pm, idBebida, nombre, idTipoProducto, gradoAlcohol);
            tx.commit();
            
            log.trace ("Inserción bebida: " + nombre + ": " + tuplasInsertadas + " tuplas insertadas");
            return new Cliente (idBebida,nombre, idTipoProducto, gradoAlcohol);
        }
        catch (Exception e)
        {
//        	e.printStackTrace();
...
//        	e.printStackTrace();
	 ...
	 */
	public Categoria adicionarBebedor(String nombre, String ciudad, String presupuesto) 
	{
		PersistenceManager pm = pmf.getPersistenceManager();
        Transaction tx=pm.currentTransaction();
        try
        {
            ...
            return new Categoria (idBebedor, nombre, ciudad, presupuesto);
        }
        catch (Exception e)
        {
//        	e.printStackTrace();
...
//        	e.printStackTrace();
	 ...
	 */
	public List<Categoria> darBebedoresPorNombre (String nombreBebedor) 
	{
	...
	{
		return (Categoria) sqlBebedor.darBebedorPorId (pmf.getPersistenceManager(), idBebedor);
	}
	...
	{
		PersistenceManager pm = pmf.getPersistenceManager();
		Categoria bebedor = (Categoria) sqlBebedor.darBebedorPorId (pm, idBebedor);
	...
	public List<Object []> darBebedoresYNumVisitasRealizadas ()
	{
        ...
        for ( Object tupla : tuplas)
        {
			...
			resp [0] = new Categoria (idBebedor, nombreBebedor, ciudadBebedor, presupuesto);
			resp [1] = numBares;	
...
//        	e.printStackTrace();
	...
	private List<Object []> armarVisitasBebedor (List<Object []> tuplas)
	{
		...
		for (Object [] tupla : tuplas)
		{
			...
			visita [0] = new Bodega (idBar, nombreBar, ciudadBar, presupuestoBar, sedesBar);
	...
	private List<Object []> armarGustanBebedor (List<Object []> tuplas)
	{
		...
		{			
			...
			long idTipoProducto = ((BigDecimal) tupla [2]).longValue ();
			int gradoAlcohol = ((BigDecimal) tupla [3]).intValue ();
			String nombreTipo = (String) tupla [4];

			Object [] gusta = new Object [2];
			gusta [0] = new Cliente (idBebida, nombreBebida, idTipoProducto, gradoAlcohol);
			gusta [1] = nombreTipo;	
	 ...
	 */
	public Bodega adicionarBar(String nombre, String ciudad, String presupuesto, int sedes) 
	{
		PersistenceManager pm = pmf.getPersistenceManager();
        Transaction tx=pm.currentTransaction();
        try
        {
            ...
            return new Bodega (idBar, nombre, ciudad, presupuesto, sedes);
        }
        catch (Exception e)
        {
//        	e.printStackTrace();
...
//        	e.printStackTrace();
	 ...
	 * @return La lista de objetos BAR, construidos con base en las tuplas de la tabla BAR
	 */
	public List<Bodega> darBaresPorNombre (String nombreBar)
	{
	 ...
	 */
	public Bodega darBarPorId (long idBar)
	{
...
//        	e.printStackTrace();
	...
	public Estante adicionarGustan(long idBebedor, long idBebida) 
	{
        ...
        try
        {
            ...
            return new Estante (idBebedor, idBebida);
        }
        catch (Exception e)
        {
//        	e.printStackTrace();
...
//        	e.printStackTrace();
	...
	public Pedido adicionarSirven (long idBar, long idBebida, String horario) 
	{
        ...
        try
        {
            ...
            return new Pedido (idBar, idBebida, horario);
        }
        catch (Exception e)
        {
//        	e.printStackTrace();
...
//	        	e.printStackTrace();
	...
	public Producto adicionarVisitan (long idBebedor, long idBar, Timestamp fecha, String horario) 
	{
        ...
        try
        {
            ...
            return new Producto (idBebedor, idBar, fecha, horario);
        }
        catch (Exception e)
        {
//        	e.printStackTrace();
