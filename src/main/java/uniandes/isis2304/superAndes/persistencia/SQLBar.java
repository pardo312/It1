...
class SQLBar 
{
	 ...
	 */
	public Bodega darBarPorId (PersistenceManager pm, long idBar) 
	{
	 ...
	 */
	public List<Bodega> darBaresPorNombre (PersistenceManager pm, String nombreBar) 
	{
	 ...
	 */
	public List<Bodega> darBares (PersistenceManager pm)
	{
