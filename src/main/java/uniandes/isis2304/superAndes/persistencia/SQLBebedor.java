...
class SQLBebedor 
{
	 ...
	 */
	public Categoria darBebedorPorId (PersistenceManager pm, long idBebedor) 
	{
	 ...
	 */
	public List<Categoria> darBebedoresPorNombre (PersistenceManager pm, String nombreBebedor) 
	{
	 ...
	 */
	public List<Categoria> darBebedores (PersistenceManager pm)
	{
	...
	public List<Object []> darBebidasQueLeGustan (PersistenceManager pm, long idBebedor)
	{
        ...
        sql += pp.darTablaTipoProducto () + " tb ";
       	sql	+= " WHERE ";
       	sql += "bdor.id = ?";
