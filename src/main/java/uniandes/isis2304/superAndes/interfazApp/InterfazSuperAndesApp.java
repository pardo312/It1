...
public class InterfazSuperAndesApp extends JFrame implements ActionListener
{
	...
	public void abandonarCarrito( )
	{
		try 
		{
			...
			int idCarrito = Integer.parseInt(JOptionPane.showInputDialog (this, "Id del carrito a abandonar?", "Devolver Producto a Estante", JOptionPane.QUESTION_MESSAGE));
...
//			e.printStackTrace();
	...
	public void Consulta7( )
	{
		try 
		{
			...
			String tipoProducto = JOptionPane.showInputDialog (this, "tipo Producto? (ORGANICO, TECNOLOGIA, OTROS) Porfavor Ponerlo en mayusculas", "RFC7", JOptionPane.QUESTION_MESSAGE);
	...
	public void Consulta10( )
	{
		try 
		{
			String carnet = JOptionPane.showInputDialog (this, "Ingrese su carnet para poder acceder a esta funcionalidad.", "RFC10", JOptionPane.QUESTION_MESSAGE);			
